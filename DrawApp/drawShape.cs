...
namespace Assignment_1
{
    class drawShape
    {
        ...
        public Graphics drawToLine(string[] scaleCmds, Graphics g)
        {
           ...
           // g.DrawLine(pen, _x, _y, location.x, location.y);

            return g;
        }
        public Graphics moveToLine(string[] scaleCmds, Graphics g)
        {
            location location = new location();
