    ...
    public partial class Form1 : Form
    {
        ...
        public void submit()
        {
             if (textCommand.Text.ToLower() == "run")
            {
                ...
                {
                    String[] scaleCmds = line.ToLower().Split(',');
        ...
        private Graphics ShapeCommand(String[] scaleCmds)
        {
            ...
            else if (scaleCmds[0] == "drawto")
            {
                ...
                g.DrawLine(pen, location.x, location.y, Convert.ToInt16(scaleCmds[1].Trim()), Convert.ToInt16(scaleCmds[2].Trim()));

                location.x = Convert.ToInt16(scaleCmds[1].Trim());
